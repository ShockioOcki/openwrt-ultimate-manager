...
grep -Fq "sprintf('%J', dispatcher.build_url('oum/setup'))" "$ROOT/luci-theme-oum/ucode/template/themes/oum/header.ut"
! grep -Fq "jsonify(dispatcher.build_url('oum/setup'))" "$ROOT/luci-theme-oum/ucode/template/themes/oum/header.ut"
...
if command -v node >/dev/null 2>&1; then
	node --check "$ROOT/luci-theme-oum/htdocs/luci-static/resources/oum-theme-ux.js"
