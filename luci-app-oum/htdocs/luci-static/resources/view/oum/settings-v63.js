...
return view.extend({
	...
	render(data) {
		...
		const page = E('main', { 'class': 'oum-main' }, [
			E('link', { rel: 'stylesheet', href: `${L.resource('oum/oum.css')}?v=20260916-usbminimal1` }),
			...
			E('section', { 'class': 'oum-settings-panel oum-usb-panel' }, [
				...
				E('div', { 'class': 'oum-setting-actions oum-usb-actions' }, [
					...
					...(usb.runtime_ready && usb.disk ? [ E('details', { 'class': 'oum-usb-maintenance' }, [E('summary', {}, 'Обслуживание накопителя'), E('button', { 'class': 'btn cbi-button-negative', id: 'format-usb-storage', 'data-system-action': '' }, 'Форматировать ext4')]) ] : [])
				]),
