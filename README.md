...
Для версии **0.0.5** подключитесь к роутеру по SSH под `root` и
выполните:
...
Установщик **0.0.5** также находится в `dist/oum-install.sh`.
...
Версия **0.0.5** — рабочий выпуск для дальнейшего тестирования. Исходники находятся в
...
Подробности: [изменения 0.0.4](docs/release-0.0.5.md), [изменения 0.0.3](docs/release-0.0.3.md), [изменения 0.0.2](docs/release-0.0.2.md), [аудит 0.0.1](docs/release-0.0.1.md),
